...
class xmlAttribute(xmlNode):
    ...
    def __repr__(self):
        return "<xmlAttribute (%s) object at 0x%x>" % (self.name, long(id (self)))
...
class xmlElement(xmlNode):
    ...
    def __repr__(self):
        return "<xmlElement (%s) object at 0x%x>" % (self.name, long(id (self)))
...
class xmlTextReader(xmlTextReaderCore):
    ...
    def SchemaValidate(self, xsd):
        """Use W3C XSD schema to validate the document as it is
           ...
           Read(). if @xsd is None, then RelaxNG validation is
           desactivated. """
...
class xmlEntity(xmlNode):
    ...
    def __repr__(self):
        return "<xmlEntity (%s) object at 0x%x>" % (self.name, long(id (self)))
...
class xmlDtd(xmlNode):
    ...
    def __repr__(self):
        return "<xmlDtd (%s) object at 0x%x>" % (self.name, long(id (self)))
...
class xmlNs(xmlNode):
    ...
    def __repr__(self):
        return "<xmlNs (%s) object at 0x%x>" % (self.name, long(id (self)))
